                        ...
                        <tbody>
                          <?php foreach($data as $key => $value): ?>
                           <tr class="gradeA odd" role="row">
                              ...
                              <td>
                                 <a class="btn btn-xs btn-primary" href="<?php echo base_url().'admin/WithdrawalController/getWithdarwalDataById/'.$value["order_id"]; ?>" style="color: #FFF;" data-toggle="tooltip" data-placement="top" title="" data-original-title="View Details"><i class="fa fa-external-link"></i></a>
                                 <a class="btn btn-xs btn-info" href="<?php echo base_url(); ?>admin/withdrawal/user-statistic" style="color: #fff;" data-toggle="tooltip" data-placement="top" title="" data-original-title="View User Statistic"><i class="fa fa-list"></i></a>
                              </td>
                           </tr>
                       <?php endforeach; ?>
                        </tbody>
