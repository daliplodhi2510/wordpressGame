                        ...
                        <tbody>
                          <?php $i = 1; foreach($withdrawalRequest as $key => $value): ?>
                           <tr class="gradeA odd" role="row">
                              ...
                              echo '<button class="btn btn-warning btn-xs btn-block">Pending</button>';}elseif($value['release_status'] == '1'){ echo '<button class="btn btn-success btn-xs btn-block">Complete</button>';} ?></td>
