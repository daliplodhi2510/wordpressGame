...
class Users extends CI_Controller
{
	...
	public function userRegister()
	{
	    ...
	    {
	        if(!empty(trim($request['fname'])) && !empty(trim($request['lname'])) && !empty(trim($request['username'])) && !empty(trim($request['mobile'])) && !empty(trim($request['email'])) && !empty(trim($request['password'])) &&  !empty(trim($request['device_id'])))
	        {
