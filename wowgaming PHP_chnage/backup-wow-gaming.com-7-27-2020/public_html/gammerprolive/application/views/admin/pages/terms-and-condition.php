      ...
      <div class="col-lg-12">
         <div class="ibox float-e-margins">
            <div class="ibox-title">
               <h5>Create Terms and Condition</h5>
            </div>
            <div class="ibox-content">
              <form action="<?php echo base_url().'admin/PageController/storeTermsCondition';?>" method="POST">
              	<textarea name="termCondtionText" id="" cols="30" rows="10" class="summernote">
                 <?php 
