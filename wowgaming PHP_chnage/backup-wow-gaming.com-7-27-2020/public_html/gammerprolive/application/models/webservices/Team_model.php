...
class Team_model extends CI_Model
{
    ...
    {
        $this->db->select('t1.*,t2.winning_amount, t2.entry_fee,t3.match_title,t4.image as cover_image');
        $this->db->from(MATCH_WITH_ASSIGN_TEAM.' as t1');
        $this->db->join(CREATE_TEAM_PLAYER.' as t2','t2.team_id = t1.team_one_id','left');
        $this->db->join(MATCH_DETAILS.' as t3','t3.id = t2.match_id','left');
        $this->db->join(COVER_IMAGES.' as t4','t4.img_id = t3.cover_image');
